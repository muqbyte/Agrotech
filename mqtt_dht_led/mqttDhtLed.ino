...
#define sub1 "kv/cikgux/data"          // Send data every set interval...publish everytime
#define sub2 "kv/cikgux/humidity"     // Send data upon Request.....publish upon request
#define sub3 "sub/data/three"      // Listen to request.....subscrice
const char ssid[]     = "Riviera Suites";         // replace with your WiFi SSID
const char password[] = "riviera1234";          // replace with your WiFi password

const char clientId[] = "cikgux";              // replace with your MQTT Client Id
const char server[]   = "txio.uitm.edu.my";  // replace with your MQTT Broker txio.uitm.edu.my/seaic.uitm.edu.
...
// Variables
float tmp, hmd; //float decimal number
String txData; //string adalah perkataan
